                ...
                Expanded(
                  child: BlocBuilder<ProdBloc, ProdState>(
                    buildWhen: (previous, current) =>
                        previous.archiveList.length !=
                            current.archiveList.length ||
                    ...
                    builder: (context, state) {
                      if (state.archiveList.isEmpty) {
                        return Column(
                          children: [
                            ...
                            Image.asset('assets/images/archive_box.png'),
                            const SizedBox(height: 20),
                            const Text(
                              'Empty',
                              style: TextStyle(
                            ...
                            const SizedBox(height: 10),
                            Text(
                              'you have nothing added to the archive',
                              style: TextStyle(
                                  fontSize: 15,
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final pr = state.archiveList[index];
