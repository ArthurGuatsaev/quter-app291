...
extension HistoryModelQueryFilter
  ...
  QueryBuilder<HistoryModel, HistoryModel, QAfterFilterCondition> dateIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HistoryModel, HistoryModel, QAfterFilterCondition> dateEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HistoryModel, HistoryModel, QAfterFilterCondition> dateLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<HistoryModel, HistoryModel, QAfterFilterCondition> dateBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension HistoryModelQuerySortBy
  ...
  QueryBuilder<HistoryModel, HistoryModel, QAfterSortBy> sortByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<HistoryModel, HistoryModel, QAfterSortBy> sortByDateDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension HistoryModelQuerySortThenBy
  ...
  QueryBuilder<HistoryModel, HistoryModel, QAfterSortBy> thenByDate() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.asc);
    });
  }

  QueryBuilder<HistoryModel, HistoryModel, QAfterSortBy> thenByDateDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'date', Sort.desc);
    });
  }
...
extension HistoryModelQueryWhereDistinct
  ...
  QueryBuilder<HistoryModel, HistoryModel, QDistinct> distinctByDate() {
    return QueryBuilder.apply(this, (query) {
...
extension HistoryModelQueryProperty
  ...
  QueryBuilder<HistoryModel, DateTime?, QQueryOperations> dateProperty() {
    return QueryBuilder.apply(this, (query) {
